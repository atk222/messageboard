...
cp ../backend/credentials.json $TARGETFOLDER/$WEBFOLDERNAME
cp ../backend/credentials.p12 $TARGETFOLDER/$WEBFOLDERNAME
cp ../backend/client_secret.json $TARGETFOLDER/$WEBFOLDERNAME

# step 4: compile TypeScript files
node_modules/typescript/bin/tsc app.ts --strict --outFile $TARGETFOLDER/$WEBFOLDERNAME/app.js

# step 5: copy css files
cat app.css css/* > $TARGETFOLDER/$WEBFOLDERNAME/app.css

# step 6: compile handlebars templates to the deploy folder
node_modules/handlebars/bin/handlebars hb/CommentsList.hb >> $TARGETFOLDER/$WEBFOLDERNAME/templates.js
...
node_modules/handlebars/bin/handlebars hb/LoginPage.hb >> $TARGETFOLDER/$WEBFOLDERNAME/templates.js
node_modules/handlebars/bin/handlebars hb/MainProfilePage.hb >> $TARGETFOLDER/$WEBFOLDERNAME/templates.js
...
node_modules/handlebars/bin/handlebars hb/ViewPost.hb >> $TARGETFOLDER/$WEBFOLDERNAME/templates.js
